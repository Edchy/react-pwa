// credit https://github.com/stefanjudis/sparkly-text?tab=readme-ov-file
...
class SparklyText extends HTMLElement {
  ...
  #css = `
    :host {
      --_sparkle-base-size: var(--sparkly-text-size, 2em);
      --_sparkle-base-animation-length: var(--sparkly-text-animation-length, 1.5s);
      --_sparkle-base-color: var(--sparkly-text-color, #FFF);
